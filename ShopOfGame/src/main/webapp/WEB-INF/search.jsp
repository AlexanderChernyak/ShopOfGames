...
<title>Интернет-магазин поиск</title>
	...
	<div id="templatemo_wrapper">
		<div id="templatemo_header">
			...
			<div id="header_right">
				...
				%>
				<p> Здравствуйте, <%= session.getAttribute("nameUser") %>! <a href="logout">Выйти</a></p>
				<%} %>
		...
		<div id="templatemo_middle">
			...
			<a href="products" class="buy_now">Посмотреть игры</a>
		</div>
		<!-- END of middle -->
					...
					<div id="SlideItMoo_inner">
						...
						<c:forEach items="${games}" var="game">
							<div class="SlideItMoo_element">
								<a href="${pageContext.request.contextPath}/gameaddaddd/productdetail/${game.idGame}"> <img
