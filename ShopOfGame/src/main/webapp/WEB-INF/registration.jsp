...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
			...
			<div id="contact_form">
               <form method='GET' name="registration" action="add_user">
                    
                    <label for="lasttname">Фамилия:</label> <input type="text" id="lastname" name="lastname" class="required input_field" />
                    <div class="cleaner h10"></div>
                    
                    <label for="firstname">Имя:</label> <input type="text" id="firstname" name="firstname" class="required input_field" />
                    <div class="cleaner h10"></div>
                    
                    <label for="patronymic">Отчество:</label> <input type="text" id="patronymic" name="patronymic" class="required input_field" />
                    <div class="cleaner h10"></div>
                    
                    <label for="date_of_birdth">Дата рождения:</label> <input type="date"  id="date_of_birdth" name="date_of_birdth" class="required input_field" />
                    <div class="cleaner h10"></div>
                    
                    <label for="phone">Телефон:</label> <input type="text" name="phone" id="phone" class="input_field" />
                    <div class="cleaner h10"></div>
                    
                    <label for="num_of_cards">Номер карточки:</label> <input type="number" min="0" id="num_of_cards" name="num_of_cards" class="required input_field" />
                    <div class="cleaner h10"></div>
						
                    <label for="e_mail">E-mail:</label> <input type="email" id="e_mail" name="e_mail" class="validate-email required input_field" />
                    <div class="cleaner h10"></div>
