    ...
    <div id="templatemo_main">
        ...
        <h3>Администрирование</h3>
        	<ul class="sidebar_menu">
        		<li><a href="add_game_page">Добавить игру</a></li>
        	</ul>
   	    <h3>Категории</h3>
				<ul class="sidebar_menu">
        ...
        <div id="content">
			...
			<div id="contact_form">
               <form method='POST' name="addGame" action="add_game" enctype="multipart/form-data">
                    
                    <label for="name">Название:</label> <input type="text" id="name" name="name" class="required input_field" required />
                    ...
                    <label for="year_of_manufacture">Год выпуска:</label> <input type="date" id="year_of_manufacture" name="year_of_manufacture" class="required input_field" required />
                    <div class="cleaner h10"></div>
                    
                    <label for="description">Описание:</label> <textarea id="description" name="description" rows="0" cols="0" class="required" required></textarea>
                    <div class="cleaner h10"></div>
                    
                    <label for="price">Цена:</label> <input type="number" min="0" step="0.1" id="price" name="price" class="required input_field" required/>
                    <div class="cleaner h10"></div>
                    
                    <label for="systemrequirements">Системные требования:</label> <textarea id="systemrequirements" name="systemrequirements" rows="0" cols="0" class="required" required></textarea>
                    <div class="cleaner h10"></div>
                    
                    <label for="amount">Количество:</label> <input type="number" min="0" step="1" name="amount" id="amount" class="required input_field" required/>
                    <div class="cleaner h10"></div>
                    
                    <label for="publicherhouse">Издатель:</label> <input type="text" id="publicherhouse" name="publicherhouse" class="required input_field" required/>
                    <div class="cleaner h10"></div>
					...
					</select><div class="cleaner h10"></div>
                    <input type = "file" name = "file" required /> 
        
					<input type="submit" value="Добавить" id="submit" name="submit" class="submit_btn float_l" />
